...
GW_PORT = 8333      # Getwork Proxy Port
...
CENTRAL_WALLET = 'QfceezwzZKoEvuCZyMM33eLr15YsBRn4f9'	# local coin address where money goes

COINDAEMON_TRUSTED_HOST = 'localhost'
COINDAEMON_TRUSTED_PORT = 9999
COINDAEMON_TRUSTED_USER = 'quarkcoinrpc'
COINDAEMON_TRUSTED_PASSWORD = 'qwerty123'
...
LOGFILE = 'stratum_net2.log'		# eg. 'stratum.log'
LOGLEVEL = 'DEBUG'
...
PASSWORD_SALT = 'sasfome_crazy_string'
...
POOL_TARGET = 0.008                     # Pool-wide difficulty target int >= 1
...
VDIFF_TARGET_TIME = 1                # Target time per share (i.e. try to get 1 share per this many seconds)
VDIFF_RETARGET_TIME = 12                # Check to see if we should retarget this often
